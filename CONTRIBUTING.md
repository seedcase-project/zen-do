...
while using zen-do. You can do this by creating a
[new](https://github.com/seedcase-project/zen-do/issues/new/choose) issue on our
GitHub repository.
...
terminal so that the working directory is the root of this project (`zen-do/`)
and running:
